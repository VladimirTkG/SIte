...
<div class="product">
  ...
  $query = "SELECT Nazvanie, kolvo, cena, NazvanieKat, tovar.ID FROM tovar,kategoritov WHERE kategoritov.ID = IDKategori AND NazvanieKat LIKE 'Напиток'";
  $result = mysqli_query($link, $query);

  $query1= "SELECT COUNT(*) FROM tovar,kategoritov WHERE kategoritov.ID = IDKategori AND NazvanieKat LIKE 'Напиток'";
